...
#   last <- length(thisdf) #Locate the mark variable for later removal
#   if (is.null(name)){
#     dv <- formula(model)[[2]]
#   }
#   else{
...
#NOT USED
#inModel <- function(obj, thisdf){
#  thisdf[names(fitted.values(obj)),colnames(obj$model)]
#}
